...
function setupStyles() {
    ...
    //append the link element tot eh document head
    document.head.appendChild(pageStyle);
    pageStyle.disabled = true;

    //insert buttond fot the style switcher
    ...
    //append an embbeded stylesheet to the document head
    var buttonStyles = document.createElement("style");
    document.head.appendChild(buttonStyles);

    //add style rules to the document
